...
export default function Sidebar() {
  ...
  const adminLinks = [
    ...
    { to: "/admin/tasks",       icon: <ClipboardList size={16} />,   label: "Tasks" },
    { to: "/admin/assignments", icon: <CheckSquare size={16} />,     label: "Assignments" },
    { to: "/admin/employees",   icon: <Users size={16} />,           label: "Employees" },
    { to: "/admin/skills",      icon: <Zap size={16} />,             label: "Skills Matrix" },
    { to: "/admin/users",       icon: <UserCog size={16} />,         label: "User Accounts" },
    { to: "/admin/progress",    icon: <TrendingUp size={16} />,      label: "Progress Reports" },
    { to: "/admin/feedback",    icon: <MessageSquare size={16} />,   label: "Feedback" },
    { to: "/admin/log",         icon: <ScrollText size={16} />,      label: "Activity Log" },
  ...
  const managerLinks = [
    ...
    { to: "/manager/tasks",       icon: <ClipboardList size={16} />,   label: "Tasks & Assign" },
    { to: "/manager/employees",   icon: <Users size={16} />,           label: `${managedDept || "Dept"} Team` },
    { to: "/manager/assignments", icon: <UserCheck size={16} />,       label: "Assignments" },
    { to: "/manager/progress",    icon: <TrendingUp size={16} />,      label: "Progress Reports" },
    { to: "/manager/feedback",    icon: <MessageSquare size={16} />,   label: "Feedback" },
  ...
  const employeeLinks = [
    ...
    { to: "/employee/tasks",         icon: <ClipboardList size={16} />,   label: "My Tasks" },
    { to: "/employee/availability",  icon: <CalendarDays size={16} />,    label: "Availability" },
  ...
  const sectionLabel = user.role === "admin" ? "Admin Panel" : user.role === "manager" ? `Manager (${managedDept || "Dept"})` : "Employee Menu";

  return (
    <aside className="app-sidebar">
      <div className="sb-brand">
        <div className="sb-logo">WA</div>
        <span className="sb-brand-name">Work Allocation</span>
      </div>
      ...
      <div className="sb-bottom">
        ...
        <div className="sb-user" style={{ marginTop: 4 }}>
          <div className="avatar avatar-sm" style={{ background: "#0d6efd", color: "#ffffff" }}>{initials(user.name)}</div>
          <div style={{ flex: 1, minWidth: 0 }}>
            <div className="sb-user-name">{user.name}</div>
            <div className="sb-user-role">{user.role}</div>
          </div>
        </div>
        <button className="sb-link" style={{ color: "#ff6b6b", marginTop: 4 }}
